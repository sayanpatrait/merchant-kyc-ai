...
public class AiChatService {
    ...
    public AiChatService(ChatClient.Builder builder,
        ...
        this.chatClient = builder
                .defaultSystem("""
                    You are a KYC operations assistant for MERCHANTS and CUSTOMERS.
                    ...
                    THEN ACT:
                    - verifyMerchant / verifyCustomer (single)
                    - verifyAllRemainingMerchants / verifyAllRemainingCustomers (bulk)
    ...
    private List<String> extractToolNames(ChatResponse response) {
        ...
        try {
            Map<String, Object> metadata = response.getMetadata() != null
                    ? response.getMetadata().entrySet().stream()
        ...
        } catch (Exception ignored) { /* metadata shape varies by Spring AI version */ }
        return names;
    }
}